...
.asset-showcase-slot .base_business_icon_o,

.asset-showcase-slot .base_business_icon_c,

.asset-showcase-slot .autoship_icon,

.asset-showcase-slot .autoship_icon_o,

.asset-showcase-slot .autoship_icon_c,

.asset-showcase-slot .recommend_bonus_icon,

.asset-showcase-slot .recommend_bonus_icon_o,

.asset-showcase-slot .recommend_bonus_icon_c{
...
.asset-showcase-slot .base_business_icon_o.asset-enter,

.asset-showcase-slot .base_business_icon_c.asset-enter,

.asset-showcase-slot .autoship_icon.asset-enter,

.asset-showcase-slot .autoship_icon_o.asset-enter,

.asset-showcase-slot .autoship_icon_c.asset-enter,

.asset-showcase-slot .recommend_bonus_icon.asset-enter,

.asset-showcase-slot .recommend_bonus_icon_o.asset-enter,

.asset-showcase-slot .recommend_bonus_icon_c.asset-enter{
