...
.lev_container,.badge_container,.sub_asset_container,.more_badge_container,.more_asset_container{display:flex;flex-wrap:wrap;gap:24px;align-items:center}
.asset-preview-note{font-size:13px;color:#64748b;margin:-8px 0 16px;line-height:1.55}
.asset-preview-sub{font-size:12px;font-weight:700;color:#94a3b8;letter-spacing:.08em;margin:24px 0 12px}
.asset-preview-note code{font-size:12px;background:#f1f5f9;padding:2px 6px;border-radius:4px}
@media(max-width:640px){
  .more_asset_container .subscription_flow_card{--size:290px}
  .more_asset_container .business_flow_card{--size:310px}
  .more_asset_container .subscription_system_frame{--size:310px}
}
...
<div class="asset-preview">
  ...
  <section>
    <h2>MORE BADGE</h2>
    <p class="asset-preview-note">guide01 문구 교체형 정보 뱃지 · <code>Guide01.cloneTemplate('guide_info_badge')</code> · 색상은 <code>.is_green</code> / <code>.is_red</code> / <code>.is_orange</code></p>
    <!--#include file="includes/components/more_badge_container.asp"-->
  </section>

  <section>
    <h2>MORE SUB ASSET</h2>
    <p class="asset-preview-note">guide01 신규 카드·아이콘 · <code>includes/components/</code> + <code>icon_style.css</code> · <code>--size</code> 비율 스케일</p>
    <!--#include file="includes/components/more_asset_container.asp"-->
  </section>
  ...
  <section class="g01-anim-section">
    ...
    <p class="g01-anim-intro">guide01_smartguide.asp에서 사용하는 7×7 존 에셋 Motion Component 미리보기 · <code>SMART_GUIDE_DOCS.md</code> §5 규칙 기반</p>
